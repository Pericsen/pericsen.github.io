...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Nuanz | Creación de Agentes de IA y Análisis de Datos Profesional</title>
    <meta name="description" content="Nuanz es una empresa especializada en la creación de agentes de inteligencia artificial y análisis de datos, ofreciendo soluciones profesionales para potenciar tu negocio.">
    <link rel="icon" type="image/png" href="/img/Nuanz_N2.png">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "Nuanz",
      "url": "https://nuanz.info",
      "logo": "https://nuanz.info/img/Nuanz_N2.png",
      "description": "Empresa dedicada a la creación de agentes de inteligencia artificial y análisis de datos profesional.",
      "sameAs": [
        "https://www.instagram.com/nuanz",
        "https://www.linkedin.com/company/nuanz"
      ],
      "contactPoint": {
        "@type": "ContactPoint",
        "contactType": "Atención al cliente",
        "email": "info@nuanz.info"
      }
    }
    </script>

    <meta property="og:image" content="https://nuanz.info/img/Nuanz_N2.png">
